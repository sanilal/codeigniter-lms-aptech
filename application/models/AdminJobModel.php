...
class AdminJobModel extends CI_Model
{
    ...
    public function getJob($column, $value)
    {
        ...
        $this->db->select('
            ...
            GROUP_CONCAT(DISTINCT(job_quizes.quiz_id)) as quizes,
            GROUP_CONCAT(DISTINCT(job_filter_value_assignments.job_filter_id)) as job_filter_ids,
            GROUP_CONCAT(DISTINCT(job_filter_value_assignments.job_filter_value_id)) as job_filter_value_ids,
        ');
    ...
    public function getPopularJobs()
    {
        ...
        $this->db->select('
            jobs.title as label,
            COUNT(DISTINCT(CONCAT(job_applications.job_application_id))) as applications_count,
            COUNT(DISTINCT(CONCAT(job_favorites.job_id,"-",job_favorites.candidate_id))) as favorites_count,
            COUNT(DISTINCT(CONCAT(job_referred.job_id,"-",job_referred.candidate_id))) as referred_count,
        ');
    ...
    public function getJobsForCSV($ids)
    {
        ...
        $this->db->select('
            ...
            COUNT(DISTINCT(job_applications.job_id)) as applications_count,
            COUNT(DISTINCT(job_favorites.job_id)) as favorites_count,
            COUNT(DISTINCT(job_referred.job_id)) as referred_count,
            GROUP_CONCAT(DISTINCT(job_traits.title)) as traits,
            GROUP_CONCAT(DISTINCT(job_filter_values.title) SEPARATOR ",") as job_filter_values
        ');
    ...
    public function jobsList()
    {
        ...
        $this->db->select('
            ...
            departments.title as department,
            COUNT(DISTINCT(job_applications.job_application_id)) as applications_count,
            COUNT(DISTINCT(CONCAT(job_favorites.candidate_id, job_favorites.job_id))) as favorites_count,
            COUNT(DISTINCT(CONCAT(job_referred.candidate_id, job_referred.job_id))) as referred_count,
