...
class AdminRoleModel extends CI_Model
{
    ...
    public function getAll()
    {
        $this->db->select('
            roles.*,
            COUNT(DISTINCT(role_permissions.permission_id)) as permissions_count
        ');
    ...
    {
        $this->db->select('
            GROUP_CONCAT(user_roles.role_id) AS role_ids,
        ');
    ...
    public function getPermissions($role_id)
    {
        ...
        $this->db->select('
            permissions.*,
            (role_permissions.permission_id IS NOT NULL) AS selected
        ');
    ...
    {
        $this->db->select('
            GROUP_CONCAT(DISTINCT(role_permissions.permission_id)) AS permissions,
        ');
