...
<?php if ($resume) { ?>
  <table>
    ...
    <tr>
      <td colspan="2">
      <h2><?php echo site_phrase('objective'); ?></h2>
      <p><?php echo esc_output($resume['objective'], 'html'); ?></p>
      </td>
    </tr>
    <tr>
      <td colspan="2">
      <h2><?php echo site_phrase('job_experiences'); ?></h2>
      </td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <td colspan="2">
        <h2><?php echo site_phrase('qualifications'); ?></h2>
    ...
    <tr>
      <td colspan="2">
        <h2><?php echo site_phrase('languages'); ?></h2>
    ...
    <tr>
      <td colspan="2">
        <h2><?php echo site_phrase('achievements'); ?></h2>
    ...
    <tr>
      <td colspan="2">
        <h2><?php echo site_phrase('references'); ?></h2>
