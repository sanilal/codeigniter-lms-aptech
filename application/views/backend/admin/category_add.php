              ...
              <div class="col-lg-12">
                ...
                <form class="required-form" action="<?php echo site_url('admin/categories/add'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-toggle="select2" name="parent" id="parent" onchange="checkCategoryType(this.value)" required>
                    ...
                    <div class="form-group">
                        <label for="name"><?php echo get_phrase('category_description'); ?></label>
                        <!-- <input type="text" class="form-control" id="name" name = "name" required> -->
                        <textarea  class="form-control" id="description" name = "description" rows="5" cols="1"></textarea>
                    </div>
