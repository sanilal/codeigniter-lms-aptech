        ...
        <div class="col-lg-12">
          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" data-toggle="select2" name="parent" id="parent" required>
                <option value="0"><?php echo get_phrase('none'); ?></option>
                <?php // print_r($categories); die();
               // $arr = array('item2', 'item3', 'item4');
/* array_unshift($categories , 'item1');
print_r($categories); */
foreach ($categories as $category): ?>
            ...
            <div class="form-group">
              <label for="description"><?php echo get_phrase('category_description'); ?></label>
              <!-- <input type="text" class="form-control" id="code" name = "code" value="<?php //echo $category_details['code']; ?>" readonly> -->
              <textarea  class="form-control" id="description" name = "description" rows="5" cols="1"><?php echo $category_details['description']; ?></textarea>
            </div>
