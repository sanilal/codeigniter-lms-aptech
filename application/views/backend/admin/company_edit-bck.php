                            ...
                            <div class="tab-pane" id="basic_info">
                                <div class="row">
                                    ...
                                    <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="first_name"><?php echo get_phrase('company_title'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <small><?php echo get_phrase("required_for_company"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
