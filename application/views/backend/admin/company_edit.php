        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
                    <a href="<?php echo site_url('admin/companies'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-arrow-left"></i> <?php echo get_phrase('back_to_companies'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('company_edit_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('admin/companies/edit/' . $user_id); ?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="tab-pane" id="basic_info">
                                <div class="row">
                                    ...
                                    <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="company_title"><?php echo get_phrase('company_title'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="company_title" name="company_title" value="<?php echo $user_data['company_title']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
