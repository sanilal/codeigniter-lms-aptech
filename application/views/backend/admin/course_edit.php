                                ...
                                <ul class="nav nav-pills nav-justified form-wizard-header">
                                    ...
                                    <li class="nav-item jitsiLiveClassNavItem">
                                        <a href="#live-class" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                            ...
                                            <span
                                                class="d-none d-sm-inline"><?php echo get_phrase('zoom_live_class'); ?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <li class="nav-item">
                                        <a href="#jitsi-live-class" data-toggle="tab"
                                            class="nav-link rounded-0 pt-2 pb-2">
                                            <i class="mdi mdi-video-account"></i>
                                            <span
                                                class="d-none d-sm-inline"><?php echo get_phrase('jitsi_live_class'); ?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div id="description_area">
                                                            <?php  //print_r(json_decode($course_details['description'])); 
                                                            //foreach (json_decode($course_details['description_title']) as $description_title) : ?>
                                                                ...
                                                                <div class="flex-grow-1 px-3">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="<?php echo get_phrase('provide_description_title'); ?>"
                                                                            value="<?php echo $description->title; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <textarea name="description[]"
                                                                            id="description-<?php echo $row_count;?>"
                                                                            class="form-control desc-field-1 <?php echo $description->desc; ?>"
                                                                            placeholder="<?php echo get_phrase('provide_description'); ?>"><?php echo $description->desc;?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        style="" name="button"
                                                                        onclick="appendDescription(<?php echo $row_count;?>)"> <i
                                                            ...
                                                            <!-- <script>
                                                               $(document).ready(function () {
                                                                    initSummerNote([
                                                                        '#description-<?php //echo $row_count;?>'
                                                                    ]);
                                                                }); 
                                                            </script> -->
                                                            <?php else : ?>
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-grow-1 px-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea name="description[]"
                                                                            id="description-<?php echo $row_count;?>"
                                                                            class="form-control desc-field-2"
                                                                            placeholder="<?php echo get_phrase('provide_description'); ?>"><?php echo $description->desc; ?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                                                    <button type="button" class="btn btn-danger btn-sm"
                                                                        ...
                                                                        onclick="removeDescription(this)"> <i
                                                                ...
                                                                <div class="flex-grow-1 px-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea name="description[]" id="description"
                                                                            ...
                                                                            placeholder="<?php echo get_phrase('provide_description'); ?>"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="">
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                            ...
                                                            <div id="blank_description_field">
                                                                <div class="d-flex mt-2">
                                                                    <div class="flex-grow-1 px-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control"
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="notes"><?php echo get_phrase('notes'); ?></label>
                                                    <div class="col-md-10">
                                                        <textarea name="notes" id="notes"
                                                            class="form-control"><?php echo $course_details['notes']; ?></textarea>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.description').summernote('code', ''); //This line remove summercontent when load
...
<script type="text/javascript">
    ...
    var blank_description = jQuery('#blank_description_field').html();
    jQuery(document).ready(function () {
        jQuery('#blank_description_field').hide();
    ...
    function appendDescription() {
        jQuery('#description_area').append(blank_description);
        //   initSummerNote(['.description']);
      $('.description').summernote({
            inheritPlaceholder: true,
            placeholder: 'Provide Description...',
    ...
    function removeDescription(descriptionElem) {
        jQuery(descriptionElem).parent().parent().remove();
    }
