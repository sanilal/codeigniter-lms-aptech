<?php
    ...
    $number_of_jobs = $this->AdminJobBoardModel->getTotalJobs();
    $number_of_applications = $this->AdminJobBoardModel->getJobApplicationsCount();
    $number_of_departments = $this->DepartmentModel->getAllActiveCount();
    $number_of_traits = $this->AdminTraitModel->getTotal();
?>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
    ...
    <div class="col-12">
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/job-board'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    <i class="dripicons-user-group text-muted" style="font-size: 24px;"></i>
                                    <h3><span><?php echo $number_of_applications; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('number_of_applications'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/jobs'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <i class="dripicons-briefcase text-muted" style="font-size: 24px;"></i>
                                    <h3><span><?php echo $number_of_jobs; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('number_of_jobs'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/departments'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <i class="dripicons-user-group text-muted" style="font-size: 24px;"></i>
                                    <h3><span><?php echo $number_of_departments; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('number_of_departments'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/traits'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <i class="dripicons-trophy text-muted" style="font-size: 24px;"></i>
                                    <h3><span><?php echo $number_of_traits; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('number_of_traits'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
