      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                <?php echo lang('hello'); ?> <strong> <?php echo esc_output($candidate['first_name'].' '.$candidate['last_name'], 'html'); ?></strong>,
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                Congratulations for being selected for interview. Below are the details
                <br />
                <br />
