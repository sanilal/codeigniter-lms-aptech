...
<head>
  ...
  <title>A New Candidate Signed up</title>
  <style type="text/css">
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="bodycopy">
                A new user has signed up with following details on <?php echo setting('site-name'); ?>.
                <hr />
                <strong>Name</strong> : <?php echo esc_output($candidate['first_name'].' '.$candidate['last_name'], 'html'); ?><br /><br />
                <strong>Email</strong> : <?php echo esc_output($candidate['email'], 'html'); ?><br /><br />
              </td>
            </tr>
          </table>
        </td>
