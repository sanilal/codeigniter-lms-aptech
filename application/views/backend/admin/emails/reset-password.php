          ...
          <!--[if (gte mso 9)|(IE)]>
            <table width="380" align="left" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
          <![endif]-->
          <table class="col380 seventh-class" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy">
                      As you have requested, below is the link to reset your password.
                      <br />
                      Please click to create you new password
                      <br />
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
                            <a target="_blank" href="<?php echo base_url(); ?>admin/reset-password/<?php echo esc_output($token); ?>">
                              Create New Password
                            </a>
                          </td>
                        </tr>
