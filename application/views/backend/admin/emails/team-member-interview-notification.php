...
<head>
  ...
  <title><?php echo setting('site-name'); ?></title>
  <style type="text/css">
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                <?php echo lang('hello'); ?> <strong> <?php echo esc_output($user['first_name'].' '.$user['last_name'], 'html'); ?></strong>,
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                <?php echo lang('interview_schedule_for_conduct'); ?>
                <br />
                <br />
                <?php echo lang('date_time'); ?> : <strong><?php echo esc_output(date('d M, Y h:i A', strtotime($interview_time))); ?></strong>
                <br />
                <br />
                <?php echo lang('description_for_candidate'); ?>
                <br />
                <?php echo esc_output(nl2br($description), 'raw'); ?>
              </td>
            </tr>
          </table>
        </td>
