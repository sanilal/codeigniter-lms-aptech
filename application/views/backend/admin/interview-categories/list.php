...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-cube"></i> <?php echo lang('interview_categories'); ?><small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo lang('home'); ?></a></li>
      <li class="active"><i class="fas fa-clipboard-list"></i> <?php echo lang('interviews'); ?></li>
      <li class="active"><i class="fas fa-cube"></i> <?php echo lang('interview_categories'); ?></li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        ...
        <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  <?php if (allowedTo('create_interview_categories')) { ?>
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-interview-category">
                    <i class="fa fa-plus"></i> <?php echo lang('add_interview_category'); ?>
                  </button>
                  <?php } ?>
                  <div class="btn-group">
          ...
          <div class="box-body">
            ...
            <table class="table table-bordered table-striped" id="interview_categories_datatable">
              <thead>
              <tr>
...
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/admin/js/cf/interview_category.js"></script>
