<form id="admin_interview_create_update_form">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="text" name="title" class="form-control" value="<?php echo esc_output($interview['title']); ?>">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary btn-blue" id="admin_interview_create_update_form_button">
      <?php echo lang('save'); ?>
    </button>
  </div>
</form>
