...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-cube"></i> <?php echo site_phrase('job_filters'); ?><small></small></h1>
    <ol class="breadcrumb">
      ...
      <li class="active"><i class="fas fa-cube"></i> <?php echo site_phrase('job_filters'); ?></li>
    </ol>
  </section>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  <?php //if (allowedTo('create_job_filters')) { ?>
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-job-filter">
                    <i class="fa fa-plus"></i> <?php echo site_phrase('add_job_filter'); ?>
                  </button>
                  <?php //} ?>
                  <div class="btn-group">
          ...
          <div class="box-body">
            ...
            <table class="table table-bordered table-striped" id="job_filters_datatable">
              ...
              <tr>
                ...
                <th><?php echo site_phrase('values'); ?></th>
                <th><?php echo site_phrase('order'); ?></th>
                <th><?php echo site_phrase('admin_filter'); ?></th>
                <th><?php echo site_phrase('front_filter'); ?></th>
                <th><?php echo site_phrase('front_home_filter'); ?></th>
                <th><?php echo site_phrase('front_value'); ?></th>
                <th><?php echo site_phrase('front_filter_type'); ?></th>
...
<!-- page script -->
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/backend/js/cf/job_filter.js"></script>
