...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fa fa-briefcase"></i> <?php echo site_phrase('languages'); ?><small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo site_phrase('home'); ?></a></li>
      <li class="active"><i class="fa fa-briefcase"></i> <?php echo site_phrase('languages'); ?></li>
      <li class="active"><?php echo site_phrase('create'); ?></li>
    </ol>
  </section>
          ...
          <div class="box-primary">
            ...
            <form role="form" id="admin_language_update_form">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" id="admin_language_update_form_button"><?php echo site_phrase('save'); ?></button>
              </div>
            </form>
          </div>
          <!-- /.box -->
