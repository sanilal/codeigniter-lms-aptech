    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body py-2">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('add_page'); ?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
...
<div class="row ">
    <div class="col-md-10">
    	<div class="card">
    		<div class="card-body">
    			<h4 class='mb-3'><?php echo get_phrase('add_a_new_page'); ?></h4>
		    	<form action="<?php echo site_url('admin/page/add'); ?>" method="post" enctype="multipart/form-data">
		    		<div class="form-group">
		    			...
		    			<input type="text" class="form-control" name="title" id="title" placeholder="<?php echo get_phrase('enter_page_title'); ?>" required>
		    		</div>
		    		...
		    		<div class="form-group">
		    			...
		    			<select class="form-control select2" data-toggle="select2" name="page_category_id" id="page_category_id" required>
		    				...
		    				<?php foreach($this->crud_model->get_page_categories()->result_array() as $category): ?>
		    					<option value="<?php echo $category['page_category_id']; ?>"><?php echo $category['title']; ?></option>
		    				<?php endforeach; ?>
		    			</select>
		    		</div>
		    		...
		    		<div class="form-group mb-3">
						...
						<div class="wrapper-image-preview" style="margin-left: -6px;">
							<div class="box" style="width: 300px;">
								<div class="js--image-preview" style="background-image: url('<?php echo base_url('uploads/page/banner/placeholder.png') ?>'); background-color: #F5F5F5; background-size: cover; background-position: center;"></div>
					...
					<div class="form-group mb-3">
						...
						<div class="wrapper-image-preview" style="margin-left: -6px;">
							<div class="box" style="width: 300px;">
								<div class="js--image-preview" style="background-image: url('<?php echo base_url('uploads/page/thumbnail/placeholder.png') ?>'); background-color: #F5F5F5; background-size: cover; background-position: center;"></div>
								<div class="upload-options">
