...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-cube"></i> <?php echo site_phrase('question_categories'); ?><small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo site_phrase('home'); ?></a></li>
      <li class="active"><i class="fas fa-cube"></i> <?php echo site_phrase('question_categories'); ?></li>
    </ol>
  </section>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  <?php if (allowedTo('create_question_categories')) { ?>
                  <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-question-category">
                    <i class="fa fa-plus"></i> <?php echo site_phrase('add_question_category'); ?>
                  </button>
                  <?php } ?>
                  <div class="btn-group">
...
<!-- page script -->
<script src="<?php echo base_url(); ?>assets/admin/js/cf/question_category.js"></script>
