  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fas fa-cube"></i> <?php echo site_phrase('update_home_page_settings'); ?></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-tachometer-alt"></i> <?php echo site_phrase('home'); ?></a></li>
        <li class="active"><i class="fas fa-cube"></i> <?php echo site_phrase('update_home_page_settings'); ?></li>
      </ol>
    </section>
...
<!-- box -->
          <div class=" box-info">
            <div class="box-header">
              <h3 class="box-title"><?php echo site_phrase('home_page_settings'); ?></h3>
            </div>
