  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fas fa-cube"></i> <?php echo site_phrase('update_application'); ?></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-tachometer-alt"></i> <?php echo site_phrase('home'); ?></a></li>
        <li class="active"><i class="fas fa-cube"></i> <?php echo site_phrase('update_application'); ?></li>
      </ol>
    </section>
...
<!-- box -->
          <div class="box-info">
            <div class="box-header">
              <h3 class="box-title"><?php echo site_phrase('update_application'); ?></h3>
            </div>
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
