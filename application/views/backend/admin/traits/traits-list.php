...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><i class="fas fa-star-half-alt"></i> <?php echo site_phrase('traits'); ?><small></small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fas fa-tachometer-alt"></i> <?php echo site_phrase('home'); ?></a></li>
      <li class="active"><i class="fas fa-star-half-alt"></i> <?php echo site_phrase('traits'); ?></li>
    </ol>
  </section>
