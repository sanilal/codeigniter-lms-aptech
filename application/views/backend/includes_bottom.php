...
<!-- new js  start-->
<script src="<?php echo base_url(); ?>assets/backend/plugins/iCheck/iCheck.js"></script>
	 
								<!-- Files For Functionalities -->
                <script src="<?php echo base_url(); ?>assets/backend/js/cf/app.js"></script>


                <!-- Select2 -->
<script src="<?php echo base_url(); ?>assets/backend/js/cf/select2.min.js"></script>
<!-- dropify -->
<script src="<?php echo base_url(); ?>assets/backend/js/cf/dropify.min.js"></script>
<!-- jQuery Multiselect -->
<script src="<?php echo base_url(); ?>assets/backend/js/cf/jquery.multi-select.js"></script>
<!-- CKEditor -->
...
function notify(message) {
  $.NotificationApp.send("<?php echo ('heads_up'); ?>!", message ,"top-right","rgba(0,0,0,0.2)","info");
}
