...
<head>
  ...
  <title><?php echo setting('site-name'); ?> | Verify Account</title>
  <style type="text/css">
...
<tr>
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td bgcolor="#61adff" class="header">
          <!--[if (gte mso 9)|(IE)]>
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                Hello <strong> <?php echo esc_output($candidate['first_name'].' '.$candidate['last_name'], 'html'); ?></strong>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                Thanks so much for joining our site! 
                <br />
                Your email is: <strong><?php echo esc_output($candidate['email']); ?></strong>
                <br />
                <br />
                To finish signing up and activate your account, you just need to click the link below.
              </td>
            </tr>
            <tr>
                ...
                <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="button" height="45">
                      <a target="_blank" href="<?php echo base_url(); ?>activate-account/<?php echo esc_output($candidate['token']); ?>">
                        Activate Account
                      </a>
                    </td>
                  </tr>
