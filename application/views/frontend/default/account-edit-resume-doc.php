              ...
              <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="account-box">
                  <p class="account-box-heading">
                    <span class="account-box-heading-text"><?php echo site_phrase('update_resume'); ?></span>
                      ...
                      <div class="col-md-12 col-lg-12">
                        ...
                        <div class="form-group form-group-account">
                          ...
                          <select name="status" class="form-control">
                            <option value="1" <?php echo esc_output($resume['status']) == '1' ? 'selected' : ''; ?>><?php echo site_phrase('active'); ?></option>
                            <option value="0" <?php echo esc_output($resume['status']) == '0' ? 'selected' : ''; ?>><?php echo site_phrase('inactive'); ?></option>
                          </select>
