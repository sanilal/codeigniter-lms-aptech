  <!--==========================
    Intro Section
  ============================-->
  <?php /* <section id="intro" class="clearfix front-intro-section">
    <div class="container">
      <div class="intro-img">
      </div>
      <div class="intro-info">
        <?php if (setting('enable-multiple-resume') == 'yes') { ?>
        <h2><span><?php echo site_phrase('account'); ?> > <?php echo site_phrase('resumes'); ?> > <?php echo esc_output($resume['title']); ?></span></h2>
        <?php } else { ?>
        <h2><span><?php echo site_phrase('account'); ?> > <?php echo substr(site_phrase('resumes'), 0,-1); ?></span></h2>
        <?php } ?>
      </div>
    </div>
  </section><!-- #intro -->
                  ...
                  <div class="col-xs-12"> 
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="resume-general">
                        <?php include('partials/account-edit-resume-general.php'); ?>
                      </div>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                              <div class="account-box">
                                <p class="account-box-heading">
                                  <span class="account-box-heading-text"><?php echo site_phrase('job_experiences'); ?></span>
                                ...
                                <div class="container">
                                  <form class="form" id="resume_edit_experiences_form">
                                    ...
                                    <?php include('partials/account-edit-resume-experiences.php'); ?>
                                    <?php } ?>
                      ...
                      <div class="edit-resume-content">
                        <div class="row">
                          <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="account-box">
                              <p class="account-box-heading">
                                <span class="account-box-heading-text"><?php echo site_phrase('qualifications'); ?></span>
                                <span class="account-box-heading-line"></span>
                              </p>
                              <div class="container">
                                ...
                                <?php include('partials/account-edit-resume-qualifications.php'); ?>
                                <?php } ?>
                        ...
                        <div class="edit-resume-content">
                          <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                              <div class="account-box">
                                <p class="account-box-heading">
                                  <span class="account-box-heading-text"><?php echo site_phrase('languages'); ?></span>
                                  <span class="account-box-heading-line"></span>
                                </p>
                                <div class="container">
                                  ...
                                  <?php include('partials/account-edit-resume-languages.php'); ?>
                                  <?php } ?>
                        ...
                        <div class="edit-resume-content">
                          <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                              <div class="account-box">
                                <p class="account-box-heading">
                                  <span class="account-box-heading-text"><?php echo site_phrase('achievements'); ?></span>
                                  <span class="account-box-heading-line"></span>
                                </p>
                                <div class="container">
                                  ...
                                  <?php include('partials/account-edit-resume-achievements.php'); ?>
                                  <?php } ?>
                        ...
                        <div class="edit-resume-content">
                          <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                              <div class="account-box">
                                <p class="account-box-heading">
                                  <span class="account-box-heading-text"><?php echo site_phrase('references'); ?></span>
                                  <span class="account-box-heading-line"></span>
                                </p>
                                <div class="container">
                                  ...
                                  <?php include('partials/account-edit-resume-references.php'); ?>
                                  <?php } ?>
