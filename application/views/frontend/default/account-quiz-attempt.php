  ...
  <section id="intro" class="clearfix front-intro-section">
    <div class="container">
      ...
      <div class="intro-info">
        <h2><span><?php echo site_phrase('account'); ?> > <?php echo site_phrase('quizes'); ?> > <?php echo site_phrase('progress'); ?></span></h2>
      </div>
    </div>
  </section><!-- #intro -->
                ...
                <div class="account-box">
                  ...
                  <p class="quiz-attempt-info">
                    <span class="quiz-attempt-info-question-counter">
                      <?php echo site_phrase('question'); ?> <?php echo esc_output($detail['attempt'], 'html'); ?> of 
                      <?php echo esc_output($detail['total_questions'], 'html'); ?>
                    </span>
                    <span class="quiz-attempt-info-timer">
                      <?php echo site_phrase('time_remaining'); ?> : <?php echo esc_output($time['clock'], 'html'); ?></span>
                  </p>
                  ...
                  <?php } ?>
                  <?php echo form_open(base_url().'candidate/quiz-attempt', array('method' => 'post')); ?>
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-12">
                        <div class="form-group form-group-account">
                          <button type="submit" class="btn btn-success" title="Save">
                            <?php echo site_phrase('submit_move_to_next'); ?>
                          </button>
                        </div>
                      </div>
                    </div>
