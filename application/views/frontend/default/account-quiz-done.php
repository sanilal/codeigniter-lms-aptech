              ...
              <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="account-box">
                  ...
                  <p class="quiz-attempt-description">
                    <?php echo site_phrase('quiz_completed'); ?> <br />
                    <?php echo site_phrase('result'); ?> : <strong><?php echo esc_output($detail['total_questions']) != 0 ? round(($detail['correct_answers']/$detail['total_questions'])*100).'%' : '';  ?></strong><br />
                    <a href="<?php echo base_url(); ?>candidate/quizes"><?php echo site_phrase('back_to_quizes'); ?></a>
                  </p>
                </div>
              </div>
            </div>
