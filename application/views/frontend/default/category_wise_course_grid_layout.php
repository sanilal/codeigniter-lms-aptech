                    ...
                    <div class="course-box">
                        ...
                        <div class="course-details">
                            ...
                            <div class="d-block">
                                ...
                                <div class="course-subtitle d-none d-md-block  text-dark p-2">
                        <?php echo ellipsis($course['short_description'], 100); ?>
                    </div>
                                <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="anchor-btn-cnt">See
                                        More</a> 
