                ...
                <div id="demo" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <?php $banner = 'uploads/banners/' . $latest_banner['banner']; ?>
                            ...
                            <img src="<?php echo base_url($banner); ?>" class="card-img-top radius-top-10 d-block"
                                alt="<?php echo $latest_banner['title']; ?>" style="width:100%">*/ 
                                $banner_img=base_url($banner);
                                ?>
                            <?php else : /*
                            
                            <img src="<?php echo base_url('uploads/banners/placeholder.png'); ?>"
                                class="card-img-top radius-top-10 d-block" alt="<?php echo $latest_banner['title']; ?>"
                                style="width:100%"> */ 
                                 $banner_img=base_url('uploads/banners/placeholder.png');
                                ?>
                            <?php endif; ?>
                            
                        <div class="carousel-item <?php echo $banner_count == 1 ? 'active' : ''; ?>" style="background: url(<?php echo ($banner_img); ?>);">
                            
                            <div class="carousel-caption">
                                <!--specialfont-->
                                <h2 class="<?php echo $banner_count%2==0?'even-color':'odd-color';?> "> 
                                <?php echo html_entity_decode($latest_banner['heading']); ?>
                                </h2>
                                 <h3 class="<?php echo $banner_count%2==0?'even-color':'odd-color';?>"><?php echo html_entity_decode($latest_banner['subheading']); ?></h3>
                                <p> 
                                <!--text-uppercase  btn-dark -->
                                    <a class="btn btn-lg " href="<?php echo $latest_banner['button1_link']; ?>" role="button" style="background: #ffb502;padding:0.8rem 2rem!important;border-radius: 9999px;color:#fff;font-size: 1rem;
    line-height: 1.25rem;"><?php echo $latest_banner['button1_text']; ?></a> <a
                                        class="btn btn-lg" href="<?php echo $latest_banner['button2_link']; ?>" role="button" style="background: #ffb502;padding:0.8rem 2rem!important;border-radius: 9999px;color:#fff;font-size: 1rem;margin-left: 1rem;
    line-height: 1.25rem;"><?php echo $latest_banner['button2_text']; ?></a></p>
                            </div>
                            <?php /* if (file_exists($banner) && is_file($banner)) : ?>
                            <img src="<?php echo base_url($banner); ?>" class="card-img-top radius-top-10 d-block"
                                alt="<?php echo $latest_banner['title']; ?>" style="width:100%">
...
<section class="home-fact-area">
    <div class="container-lg">
        <div class="row grid-divider">
            ...
            <div
                class="col-lg-3 col-md-6 col-sm-12 col-12 d-flex justify-content-center flex-column flex-md-row align-items-center justify-content-md-start">
...
<section role="main" class="container starter-container">
    ...
    <div class="row">
        <div class="col-md">
            ...
            //$category_details = $this->crud_model->get_sub_categories($category['id']);
           ...
           // $category_details = $this->crud_model->get_category_details_by_id($top_10_category['sub_category_id'])->row_array();
                ?>
                    ...
                    <!--  <li class="nav-item active">
                        <a class="nav-link text-center" id="home-tab" data-toggle="tab" href="#home" role="tab"
                            aria-controls="home" aria-selected="true">
                            <i class="vc_tta-icon fas fa-laptop-code"></i><span class="vc_tta-title-text">IT
                                Courses</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                            ...
                            <span class="vc_tta-title-text">Multimedia Courses</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                            aria-controls="contact" aria-selected="false">
                            <i class="vc_tta-icon fas fa-cogs"></i><span class="vc_tta-title-text">Engineering
                                Courses</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-center" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                            aria-controls="contact" aria-selected="false">
                            <i class="vc_tta-icon fas fa-book-reader"></i><span class="vc_tta-title-text">Vacation
                                Courses</span>
                        </a>
                    </li> -->
                </ul>
               ...
               foreach ($categories as $category) : ?>
                    ...
                    <!-- content 1 -->
                    <div class="tab-pane masonry-container fade show <?php echo $cat_count==0?'active':'';?>"
            ...
            //$category_details = $this->crud_model->get_category_details_by_id($sub_category['id'])->row_array();?>

                            <div class="card starter-card col-lg-4 col-md-6 p-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo site_url('home/courses?category=' . $sub_category['slug']); ?>">See
                                        More</a>
                                </div>
                        ...
                        endforeach;
                            ...
                            <?php /* <li class="nav-item <?php echo $cat_count==0?'active':'';?>">
                            <a class="nav-link text-center" id="<?php echo $category['slug'];?>-tab" data-toggle="tab"
                                href="#<?php echo $category['slug'];?>" role="tab"
                                aria-controls="<?php echo $category['slug'];?>" aria-selected="false">
                                <i class="<?php echo $category['font_awesome_class'];?>"></i>
                    ...
                    <?php /*
                    <!-- content 1 -->
                    <div class="tab-pane masonry-container fade show active" id="home" role="tabpanel"
                        aria-labelledby="home-tab">
                        <div class="card-group">
                            <div class="row">


                                <div class="card starter-card col-md-4">
                                    <img class="card-img-top"
                                        src="https://images.unsplash.com/photo-1501743029101-21a00d6a3fb9?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ%3D%3D&s=04fc74cb01d267c20b706d27c2c493e5"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h2>Programming Language</h2>
                                        <p>A programming language is a formal language comprising a set of strings that
                                            produce various kinds of machine code output. Programming languages are one
                                            kind of computer language, and are used in computer programming to implement
                                            algorithms. Build your programming career with Aptech.</p>
                                        <a
                                            href="https://www.aptech.ae/all-courses/it-courses-and-certification/programming-language/">See
                                            More</a>
                                    </div>
                                ...
                                <div class="card starter-card col-md-4">
                                    <img class="card-img-top"
                                        src="https://images.unsplash.com/photo-1488740304459-45c4277e7daf?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ%3D%3D&s=49bcc37a7a6a0de2eb984e74d19f472d"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h2>Programming Language</h2>
                                        <p>A programming language is a formal language comprising a set of strings that
                                ...
                                <div class="card starter-card col-md-4">
                                    <img class="card-img-top"
                                        src="https://images.unsplash.com/photo-1482066490729-6f26115b60dc?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ%3D%3D&s=3f77fa1436c24f2227c3b69ba66cd088"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h2>Programming Language</h2>
                                        <p>A programming language is a formal language comprising a set of strings that
...
<section class="course-carousel-area p-5 p-sm-3">
  ...
  color: white;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    <?php echo word_limiter($top_course['short_description'], 11); ?>
                                                </p>
                                ...
                                <div class="d-block">
                                    <div class="floating-user d-inline-block">
                                        <?php if ($top_course['multi_instructor']) :
                                                    ...
                                                    $margin = 0;
                                                    foreach ($instructor_details as $key => $instructor_detail) { ?>
                                        <img style="margin-left: <?php echo $margin; ?>px;" class="position-absolute"
                                            src="<?php echo $this->user_model->get_user_image_url($instructor_detail['id']); ?>"
...
<section class="course-carousel-area">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h3 class="course-carousel-title mb-4"><?php echo site_phrase('top') . ' 10 ' . site_phrase('latest_courses'); ?>
</h3>
<!-- page loader -->
<div class="animated-loader">
    <div class="spinner-border text-secondary" role="status"></div>
...
<div class="course-carousel shown-after-loading" style="display: none;">
    ...
    <div class="course-box-wrap">
        <a onclick="return check_action(this);"
            ...
            <div class="course-box">
                <div class="course-image">
                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($latest_course['id']); ?>" alt=""
                        class="img-fluid">
                </div>
                <div class="course-details">
                        ...
                        <div class="col-6 text-end">
                            <button class="brn-compare-sm"
                                onclick="return check_action(this, '<?php echo site_url('home/compare?course-1=' . rawurlencode(slugify($latest_course['title'])) . '&&course-id-1=' . $latest_course['id']); ?>');"><i
                                    class="fas fa-balance-scale"></i> <?php echo site_phrase('compare'); ?></button>
                        </div>
                    </div>
                    <hr class="divider-1">
                    <div class="d-block">
                ...
                <div class="owl-carousel association-carousel">
                    ...
                    <div class="item">
                        <div class="owl_img1">
                            ...
                            <img src="<?php echo base_url($partner_logo); ?>"
                                alt="<?php echo $latest_partner['title']; ?>">
                            <?php else : ?>
                            <img src="<?php echo base_url('uploads/banners/placeholder.png'); ?>"
                                alt="<?php echo $latest_partner['title']; ?>">
                            <?php endif; ?>
        ...
        <div class="row row-cols-1 row-cols-lg-4 row-cols-md-3 g-4 justify-content-center">
            ...
            <div class="col">
                <div class="card radius-10">
                    ...
                    <img src="<?php echo base_url($blog_thumbnail); ?>" class="card-img-top radius-top-10"
                        alt="<?php echo $latest_blog['title']; ?>">
                    <?php else : ?>
                    <img src="<?php echo base_url('uploads/blog/thumbnail/placeholder.png'); ?>"
                        class="card-img-top radius-top-10" alt="<?php echo $latest_blog['title']; ?>">
                    <?php endif; ?>
                    <div class="card-body pt-4">
                        <p class="card-text">
                            <small class="text-muted"><?php echo site_phrase('created_by'); ?> - <a
                                    href="<?php echo site_url('home/instructor_page/' . $latest_blog['user_id']); ?>"><?php echo $user_details['first_name'] . ' ' . $user_details['last_name']; ?></a></small>
                        </p>
                        <h5 class="card-title"><a
                                href="<?php echo site_url('blog/details/' . slugify($latest_blog['title']) . '/' . $latest_blog['blog_id']); ?>"><?php echo $latest_blog['title']; ?></a>
                        </h5>
                        <p class="card-text ellipsis-line-3">
                            <?php echo strip_tags(htmlspecialchars_decode($latest_blog['description'])); ?>
                        </p>
                        <a class="fw-600"
                            href="<?php echo site_url('blog/details/' . slugify($latest_blog['title']) . '/' . $latest_blog['blog_id']); ?>"><?php echo site_phrase('more_details'); ?></a>
                        <p class="card-text mt-2 mb-0">
                            <small class="text-muted text-12px"><?php echo site_phrase('published'); ?> -
                                <?php echo get_past_time($latest_blog['added_date']); ?></small>
                        </p>
                    </div>
                </div>
            </div>
