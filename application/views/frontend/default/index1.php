...
<head>
	...
	<?php else: ?>
		...
		<meta property="og:image" content="<?= base_url("uploads/system/".get_frontend_settings1('banner_image')); ?>">
	<?php endif; ?>
	<meta property="og:url" content="<?php echo current_url(); ?>" />
	<meta property="og:type" content="Learning management system" />
	<!--Social sharing content-->

	<link name="favicon" type="image/x-icon" href="<?php echo base_url('uploads/system/'.get_frontend_settings1('favicon')); ?>" rel="shortcut icon" />
	<?php include 'includes_top.php';?>

</head>
<body class="<?php echo !empty($page_bg_color)?$page_bg_color:'white-bg';?>">
	<?php
	...
	if ($this->session->userdata('user_login')) {
		include 'logged_in_header1.php';
	}else {
		include 'logged_out_header1.php';
	}

	if(get_frontend_settings1('cookie_status') == 'active'):
