<?php
$instructors_details = $this->user_model->get_instructor(0)->result_array();
...
?>
<?php 
//var_dump($instructors_details); die();
?>
<div class="row">
<?php
foreach($instructors_details as $instructor_detail){
    ?>
    <div class="col-12 col-sm-3">
       <div class="d-sm-flex text-center text-md-start">
                            <div class="top-instructor-img ms-auto me-auto">
                                <a href="<?php echo site_url('home/instructor_page/' . $instructor_detail['id']); ?>">
                                    <img src="<?php echo $this->user_model->get_user_image_url($instructor_detail['id']); ?>" width="100%">
                                </a>
                            </div>
                            <div class="top-instructor-details">
                                <a class="text-decoration-none" href="<?php echo site_url('home/instructor_page/' . $instructor_detail['id']); ?>">
                                    <h4 class="mb-1 fw-700"><?php echo $instructor_detail['first_name'] . ' ' . $instructor_detail['last_name']; ?></h4>
                                    <span class="fw-500 text-muted text-14px"><?php echo ellipsis($instructor_detail['title'], 60); ?></span>
                                    <p class="text-12px fw-500 text-muted my-3"><?php echo ellipsis(strip_tags($instructor_detail['biography']), 100); ?></p>
                                    <?php $skills = explode(',', $instructor_detail['skills']); ?>
