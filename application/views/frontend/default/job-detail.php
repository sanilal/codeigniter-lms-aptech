  <!--==========================
    Intro Section
  ============================-->
  <?php $upOne = realpath(dirname(__FILE__) . '/..');?>
        ...
        <h2>
          <span>
            <a href="<?php echo base_url(); ?>jobs">
              <?php echo site_phrase('browse_jobs'); ?></a> : <?php echo esc_output($job['title'], 'html'); ?>
            </span>
          </h2>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container">
        ...
        <div class="row mt-10">
          <div class="col-lg-3">
            <?php include('partials/job-sidebar.php'); ?>
          </div>
          <div class="col-md-9 col-lg-9 col-sm-12">
                ...
                <div class="job-detail">
                  ...
                  <p class="job-listing-job-info">
                    ...
                    <span class="job-listing-job-info-item mark-favorite <?php echo $favorite ? 'favorited' : ''; ?>"
                      title="<?php echo $favorite ? 'Unmark' : 'Mark'; ?> <?php echo site_phrase('favorite'); ?>"
              ...
              <?php if (!in_array($job['job_id'], $applied)) { ?>
                  ...
                  <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="job-detail">
                      ...
                      <p class="job-detail-job-description">
                        <?php echo site_phrase('please_rate_yourself'); ?>
                      </p>
                      <div class="row">
                          ...
                          <div class="col-md-6 col-lg-6 col-sm-12">
                            <p class="job-detail-job-trait">
                              ...
                              <select class="pill-rating" name="traits[<?php echo encode($trait['id']); ?>]" autocomplete="off">
                                <option value="0"><?php echo site_phrase('n_a'); ?></option>
                                <option value="1"><?php echo site_phrase('poor'); ?></option>
                                <option value="2"><?php echo site_phrase('bad'); ?></option>
                                <option value="3"><?php echo site_phrase('average'); ?></option>
                                <option value="4"><?php echo site_phrase('good'); ?></option>
                                <option value="5"><?php echo site_phrase('excellent'); ?></option>
                              </select>
                            </p>
                          </div>
                        <?php } ?>
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="job-detail">
                      <p class="job-detail-heading">
                        <span class="job-detail-heading-text"><?php echo site_phrase('apply_for_this_job'); ?></span>
                        <span class="job-detail-heading-line"></span>
                      </p>
                      <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12">
                          <p class="job-detail-job-trait">
                            <label><?php echo site_phrase('please_select_one_of_your_resume'); ?></label>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                          <p class="job-detail-job-trait">
                            <button href="#" type="submit" class="btn btn-primary" 
                              title="Apply" id="job_apply_form_button"><?php echo site_phrase('apply'); ?></button>
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="job-detail account-no-content-box">
                      <?php echo site_phrase('you_have_already_applied'); ?><br />
                      <a href="<?php echo base_url(); ?>account/job-applications"><?php echo site_phrase('go_to_job_applications'); ?></a>
                    </div>
                  </div>
                </div>
              <?php } ?>
            <?php } else { ?>
              <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12">
                  <div class="job-detail account-no-content-box">
                    <?php echo site_phrase('you_need_to_be_logged_in'); ?><br />
                    <a href="<?php echo base_url(); ?>login"><?php echo site_phrase('login'); ?></a>
                  </div>
                </div>
              </div>
            <?php } ?>
