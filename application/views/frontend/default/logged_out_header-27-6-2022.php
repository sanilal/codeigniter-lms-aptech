...
<label :data-state="opan" for="search">
                  ...
                  <div class="container-fluid">
                     <nav class="navbar">
                        ...
                        <div class="navbar-collapse" id="main_nav">
                            <ul id="menu-main-menu-1" class="nav justify-content-center">
                                <li class="nav-item"><a class="nav-link" class="nav-link active" title="Home" href="<?php echo site_url(''); ?>">Home</a></li>
                                <li class="nav-item"><a class="nav-link" title="About Us" href="<?php echo site_url('about-aptech'); ?>">About Us</a></li>
                                <li class="nav-item dropdown">
                                   <a class="nav-link" title="Courses" href="<?php echo site_url('home/courses'); ?>">Courses <span class="fa fa-angle-down"></span></a>
                                      <ul role="menu" class="dropdown-menu">
                                         <li class="nav-item dropdown">
                                            <a class="nav-link" title="IT" href="#">IT <span class="fa fa-angle-right"></span></a>
                                               <ul role="menu" class="dropdown-menu">
                                                  <li class="dropdown">
                                                     <a class="nav-link" title="Python" href="#">Python <span class="fa fa-angle-right"></span></a>
                                                        <ul role="menu" class="dropdown-menu">
                                                           <li class="nav-item"><a class="nav-link" title="Python for Beginners" href="#">Python for Beginners</a></li>
                                                           <li class="nav-item"><a class="nav-link" title="Advanced Python" href="#">Advanced Python</a></li>
                                                        </ul>
                                                  </li>
                                               </ul>
                                         </li>
                                         <li class="dropdown">
                                            <a class="nav-link" title="Multimedia Courses" href="#">Multimedia Courses <span class="fa fa-angle-right"></span></a>
                                               <ul role="menu" class="dropdown-menu">
                                                  <li class="dropdown">
                                                     <a class="nav-link" title="Graphic Designing" href="#">Graphic Designing <span class="fa fa-angle-right"></span></a>
                                                        <ul role="menu" class="dropdown-menu">
                                                           <li class="nav-item"><a class="nav-link" title="Adobe Photoshop CC" href="#">Adobe Photoshop CC</a></li>
                                                           <li class="nav-item"><a class="nav-link" title="Adobe Illustrator CC" href="#">Adobe Illustrator CC</a></li>
                                                        </ul>
                                                  </li>
                                               </ul>
                                         </li>
                                         <li class="dropdown  ">
                                            <a class="nav-link" title="Engineering" href="#">Engineering <span class="fa fa-angle-right"></span></a>
                                               <ul role="menu" class="dropdown-menu">
                                                  <li class="dropdown  ">
                                                     <a class="nav-link" title="AutoCAD" href="#">AutoCAD <span class="fa fa-angle-right"></span></a>
                                                        <ul role="menu" class="dropdown-menu">
                                                           <li class="nav-item"><a class="nav-link" title="2D &amp; 3D AutoCAD" href="#">2D &amp; 3D AutoCAD</a></li>
                                                        </ul>
                                                  </li>
                                               </ul>
                                         </li>
                                         <li class="dropdown">
                                            <a class="nav-link" title="Vacation Courses" href="#">Vacation Courses <span class="fa fa-angle-right"></span></a>
                                               <ul role="menu" class="dropdown-menu">
                                                  <li class="dropdown  ">
                                                     <a class="nav-link" title="Whiz Kids &amp; Wonder Teens" href="#">Whiz Kids &amp; Wonder Teens <span class="fa fa-angle-right"></span></a>
                                                        <ul role="menu" class="dropdown-menu">
                                                           <li class="nav-item"><a class="nav-link" title="2D Animation" href="#">2D Animation</a></li>
                                                        </ul>
                                                  </li>
                                               </ul>
                                         </li>
                                ...
                                <li class="nav-item"><a class="nav-link" title="Corporate" href="#">Corporate</a></li>
                                <li class="nav-item"><a class="nav-link" title="Summer Courses" href="#">Summer Courses</a></li>
                                <li class="nav-item"><a class="nav-link" title="Contact" href="<?php echo site_url('contact-us'); ?>">Contact</a></li>
                             </ul>
                        </div> <!-- navbar-collapse.// -->
                    </nav>   
                  </div>
...
$header_sub_categories = $this->crud_model->get_sub_categories($header_category['id']);
...
foreach ($header_sub_categories as $header_sub_category) : ?>
  <li class="nav-item dropdown"><a class="dropdown-item dropdown-toggle" href="<?php echo site_url('home/courses?category=' . $header_sub_category['slug']); ?>"
