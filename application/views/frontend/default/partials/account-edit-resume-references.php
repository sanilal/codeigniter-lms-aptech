<div class="row resume-item-edit-box-section reference-box">
  ...
  <div class="col-md-6 col-lg-6">
    <div class="form-group form-group-account">
      ...
      <small class="form-text text-muted"><?php echo site_phrase('enter_person_name'); ?>.</small>
    </div>
    <div class="form-group form-group-account">
      ...
      <small class="form-text text-muted"><?php echo site_phrase('enter_person_company'); ?></small>
    </div>
    <div class="form-group form-group-account">
      <label for=""><?php echo site_phrase('email'); ?> *</label>
      <input type="text" class="form-control" placeholder="Email" name="email[]" 
        value="<?php echo esc_output($reference['email']); ?>">
      <small class="form-text text-muted"><?php echo site_phrase('enter_person_email'); ?></small>
    </div>
  </div>
  <div class="col-md-6 col-lg-6">
    <div class="form-group form-group-account">
      <label for=""><?php echo site_phrase('relation'); ?> *</label>
      <input type="text" class="form-control" placeholder="Boss / Colleague" name="relation[]" 
        value="<?php echo esc_output($reference['relation']); ?>">
      <small class="form-text text-muted"><?php echo site_phrase('enter_relation_association'); ?></small>
    </div>
    <div class="form-group form-group-account">
      <label for=""><?php echo site_phrase('phone'); ?></label>
      <input type="text" class="form-control" placeholder="1234567890" name="phone[]" 
        value="<?php echo esc_output($reference['phone']); ?>">
      <small class="form-text text-muted"><?php echo site_phrase('enter_person_phone'); ?></small>
    </div>
  </div>
</div>
