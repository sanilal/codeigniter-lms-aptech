<section class="page-header-area my-course-area">
  ...
  <div class="container">
    <ul class="print-hidden">
      ...
      <li class="<?php if($page_name == 'jobs' || $page_name == 'job-detail' || $page_name == 'account-job-applications'|| $page_name == 'account-quiz-listing') echo 'active'; ?>"><a href="<?php echo site_url('candidate/job-applications'); ?>"> <i class="fas fa-briefcase"></i> <?php echo site_phrase('jobs'); ?></a></li>
    </ul>
    </div>
</section>