...
//execute curl
$url = 'https://maps.googleapis.com/maps/api/place/details/json?cid='.$cid.'&key=AIzaSyCb6_yUSFhe-7RHGkJKRlYyopKTsHZu6BI';
$ch = curl_init();
...
/*
//display on view
//https://mybusiness.googleapis.com/v4/accounts/113972638344249579414/locations/ChIJZw3XszVoXz4RkhohpkfBYXM/reviews
$url='https://mybusiness.googleapis.com/v4/accounts/113972638344249579414/locations/ChIJZw3XszVoXz4RkhohpkfBYXM/reviews';
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
...
*/
/*
//$url = "https://maps.googleapis.com/maps/api/place/details/json?key=AIzaSyCnxY_QJF-U0sJBX-4F4TVDcTXcbK9Vfy0&placeid=ChIJR3bT8TxDXz4RaAmjYocU1-Y";
...
/*
    ...
    */
    ...
    $place_ID       = 'ChIJR3bT8TxDXz4RaAmjYocU1-Y'; // Get from: https://developers.google.com/places/place-id
